...
Canonical Protobuf contracts for the training framework. The current version is `0.6.0`. The build produces C++ and Python bindings with a checksum manifest.
